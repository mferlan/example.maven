...
public class TestedServiceTest {
    ...
    @Before
    public void setUp() {
        objectToTest = new TestedService();
    ...
    public void shouldDividePositiveNumbers() {
        ...
        double divisor = 2.0d;
        Mockito.when(mockedInterface.divide(dividend, divisor)).thenReturn(5.0d);

        // when
        double result = objectToTest.positiveDivide(dividend, divisor);
